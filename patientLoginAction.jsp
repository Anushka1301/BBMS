...
<%
    ...
    if(rs.next())
    {
        ...
        {
            out.print("<script>alert('Invalid user');window.location.href='patientLogin.jsp';</script>");
        }
    }
    else
    {
        out.print("<script>alert('user does not exist');window.location.href='patientLogin.jsp';</script>");
    }
    %>