        ...
        <tr>
            <%
               ...
               <td><%=rs.getString(1) %></td>
                ...
                <td><a href="adminPatientAccept.jsp?gmail=<%=rs.getString(3)%>"><i class="fa fa-check-circle"></i></a></td>
                <td><a href="deletePatientReqestHistory.jsp?gmail=<%=rs.getString(3)%>"><i class="fa fa-trash"></i></a></td>
        </tr>
        <%
        }
        }
