    ...
    <table id="customers">
        ...
        <tr>
            <%
                ...
                <td><a href="updateDonor.jsp?email=<%=rs.getString(5)%>"><i class="fa fa-edit"></i></a></td>
                <td><a href="deleteDonationHistory.jsp?email=<%=rs.getString(5)%>"><i class="fa fa-trash"></i></a></td>
