...
<body>
   <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-danger">
        <a style="color:white;" class="navbar-brand" href="/"><i class="fab fa-gratipay"></i>&nbsp;<font face = "Comic sans MS" size ="4">Welcome to donor Home</font></a>
    ...
    <table id="customers">
        ...
        <tr>
            <%
                ...
                <td><a href="deleteDonor.jsp?id=<%=rs.getString(1)%>"><i class="fa fa-trash"></i></a></td>
        </tr>
        <%
        }
        }
...
<br>
<br>
<h4><center><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
