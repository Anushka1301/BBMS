...
<body>
    ...
    <div class="wrapper">
        ...
        <form class="p-3 mt-3" action="patientLoginAction.jsp" method="post">
            <div class="form-field d-flex align-items-center">
                <span class="far fa-user"></span>
                <input type="text" name="emailaddress" id="Username" placeholder="Username">
            </div>
            <div class="form-field d-flex align-items-center">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <h6>Captcha not visible <img src="images/refresh.jpg" style="width:30px;height:30px"  onclick="cap()"></h6>
           ...
           <div class="form-group" style="text-align:center"></div>
            ...
            <a>New User</a>     <a href="registration.jsp">Registration here !</a>
        </div>                    
			</div>
		</form>
